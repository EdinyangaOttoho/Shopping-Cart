<html>
	<head>
		...
		<meta charset="UTF-8">
		<meta name="description" content="Sign Up to Buy all your desired T-shirts here at affordable costs. You will leave with no regrets after being offered our services">
	...
	<body>
		...
		<div class="form-modal">
			<center><h1 class="small" style="color:hotpink">Register</h1></center>
			<br/>
			<form method="POST" id="form">
				<div class="head" id="a1">First Name *</div>
				<div class="span">
					<input type="text" class="field" id="a2" name="firstname" onkeypress="ev(event)">
				</div>
				<br/>
				<br/>
				<div class="head" id="b1">Last Name *</div>
				<div class="span">
					<input type="text" class="field" id="b2" name="lastname" onkeypress="ev(event)">
				</div>
				<br/>
				<br/>
				<div class="head" id="c1">Email *</div>
				<div class="span">
					<input type="text" class="field" id="c2" name="email" oninput="validatorem()" onkeypress="ev(event)">
				</div>
				...
				<div class="span">
					<input type="password" class="field" id="d2" oninput="validatorpass()">
				</div>
				<label id="password-error" class="errors"></label>
				<br/>
				<br/>
				<div class="head" id="e1">Repeat Password *</div>
				<div class="span">
					<input type="password" class="field" id="e2" name="password" oninput="validatorre()">
				</div>
				<label id="repeat-error" class="errors"></label>
				<br/>
				<br/>
				<center>
					<button type="button" class="submit" id="subm" onclick="create()">SUBMIT</button>
				</center>
				<br/>
				</div>
			</form>
